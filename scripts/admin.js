...
const STATUSES = [
    ...
    "Your package is been updated", "In Transit", "Customs Clearance", "Arrived at Facility",
...
async function submitCreateShipment() {
    ...
    try {
        ...
        await window.db.addShipmentHistory({
            ...
            description: "Electronic shipping details received and processed. Your package is been updated."
        });
...
async function openUpdateModal(id, trackingNo, currentStatus) {
    ...
    document.getElementById('update-desc').value = 'Your package is been updated';
...
async function loadModalHistoryList(shipmentId) {
    ...
    try {
        ...
        history.forEach(item => {
            ...
            const desc = item.description || 'Your package is been updated';
...
async function submitUpdateHistory() {
    ...
    const details = document.getElementById('update-desc').value.trim() || 'Your package is been updated';
...
function openEditHistoryModal(item) {
    ...
    document.getElementById('edit-history-status').value = item.status || 'Your package is been updated';
    document.getElementById('edit-history-location').value = item.location || '';
    document.getElementById('edit-history-desc').value = item.description || 'Your package is been updated';
...
async function submitEditHistoryItem() {
    ...
    const desc = document.getElementById('edit-history-desc').value.trim() || 'Your package is been updated';
